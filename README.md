...
* You can use the latest version (0.8.5) by adding it to the head section of your HTML document:

**v0.8.5**

    <script src="https://unpkg.com/ml5@0.8.5/dist/ml5.min.js" type="text/javascript"></script>
